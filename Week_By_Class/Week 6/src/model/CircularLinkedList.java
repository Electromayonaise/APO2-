...
public class CircularLinkedList {
    ...
    // As the NodeWithSameKeyException is a runtime exception, we don't have to use the throws keyword
    public void addNode(Node node){
        ...
        // added to first position
            ...
            if(!this.tail.getKey().equals(node.getKey())){
                ...
                throw new NodeWithSameKeyException("This key already exists");
                // This exception isn't well implemented, as we are only checking the last node, but it's just for the example
            }
        }
    }
    ...
    private String delete(String goal, Node current) throws IsEmptyCircularLinkedListException, NodeNotFoundException {
        ...
        // en la lista circular el valor del current nunca será null
            ...
            throw new NodeNotFoundException(str = "This element does not exist");
        }
